"""A small AD LAN, well formed: every check passes.

The section 7 scenario of the design document, trimmed to what M0 can check: no internet
stub and no adapter-driven attack sequence."""
